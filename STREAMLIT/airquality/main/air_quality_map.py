#!/usr/bin/env python3
"""
Application interactive de qualité de l'air avec carte
Permet à l'utilisateur de saisir son adresse et visualiser les données de sa zone
"""
...
import numpy as np
from airquality.app.db_utils import AirQualityDB
import webbrowser
import os
...
class AirQualityMapper:
    ...
    def create_location_map(self, address):
        ...
        folium.Circle(
            ...
            popup=f"Zone d'influence (1km) - {summary['address']}",
            color=aqi_color,
            fillColor=aqi_color,
            fillOpacity=0.2
        ).add_to(m)
